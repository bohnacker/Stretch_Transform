...
public class Anchor {
  ...
  Anchor(PVector p) {
    originPosition = p.copy();
    targetPosition = p.copy();
  }
  ...
  Anchor(PVector pOrigin, PVector pTarget) {
    originPosition = pOrigin.copy();
    targetPosition = pTarget.copy();
  }

  PVector getOriginPosition() {
    return originPosition.copy();
  }
